#pythonGUI
from tkinter import *
#importing the random shuffle method to change the order of cards in the deck
#(this lets us practice real probablity in one deck black jack and lets the user count the cards)
import os
import random
...
def get_deck():
    """Return a new deck of cards(standard french 52 card deck)."""
...
#Calling tkinter to draw the described GUI
#root = Tk()
#root.mainloop()